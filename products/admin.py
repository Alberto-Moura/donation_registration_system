...
class AcronymAdmin(admin.ModelAdmin):
    list_display = ('acronym', 'id', 'description', 'created_at', 'updated_at')
    list_filter = ('acronym', 'created_at', 'updated_at')
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('name', 'id', 'compound_quantity', 'category', 'acronym', 'created_at', 'updated_at')
